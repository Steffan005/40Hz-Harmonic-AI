#!/usr/bin/env python3
"""
PoetPerformer - Specialist agent for Poet Office
"""
...
class PoetPerformer:
    """
    Presents or performs works for Poet
    ...
    def __init__(self):
        self.name = "PoetPerformer"
        self.model = "deepseek-r1:14b"
        self.tools = ['generation_engine', 'style_analyzer', 'gallery_manager']
        self.system_prompt = """You are a PoetPerformer specialist in the Poet office.
