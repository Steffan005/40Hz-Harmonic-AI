#!/usr/bin/env python3
"""
PoetManager - Coordination and oversight for Poet Office
"""
...
class PoetManager:
    """
    Manager agent for Poet office.

    Coordinates 4 specialist agents:
        - PoetCreator: Generates original artistic content for Poet
    - PoetCritic: Analyzes and critiques artistic works for Poet
    - PoetCurator: Selects and organizes collections for Poet
    - PoetPerformer: Presents or performs works for Poet
    """

    def __init__(self):
        self.domain = "Poet"
        self.model = "deepseek-r1:14b"
        self.specialists = ['PoetCreator', 'PoetCritic', 'PoetCurator', 'PoetPerformer']
        self.tools = ['generation_engine', 'style_analyzer', 'gallery_manager']

        # System prompt
        self.system_prompt = """You are the Poet Manager, overseeing 4 specialist agents.
...
if __name__ == "__main__":
    manager = PoetManager()
    result = manager.execute("Sample request for Poet")
    print(result)
