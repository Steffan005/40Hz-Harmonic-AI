#!/usr/bin/env python3
"""
MusicianCreator - Specialist agent for Musician Office
"""
...
class MusicianCreator:
    """
    Generates original artistic content for Musician
    ...
    def __init__(self):
        self.name = "MusicianCreator"
        self.model = "deepseek-r1:14b"
        self.tools = ['generation_engine', 'style_analyzer', 'gallery_manager']
        self.system_prompt = """You are a MusicianCreator specialist in the Musician office.
