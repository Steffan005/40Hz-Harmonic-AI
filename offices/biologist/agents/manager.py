#!/usr/bin/env python3
"""
BiologistManager - Coordination and oversight for Biologist Office
"""

from typing import Dict, List, Any


class BiologistManager:
    """
    Manager agent for Biologist office.

    Coordinates 4 specialist agents:
        - BiologistResearcher: Conducts literature review and hypothesis generation for Biologist
    - BiologistModeler: Builds computational or mathematical models for Biologist
    - BiologistExperimenter: Designs and simulates experiments for Biologist
    - BiologistReporter: Writes research summaries and papers for Biologist
    """

    def __init__(self):
        self.domain = "Biologist"
        self.model = "deepseek-r1:14b"
        self.specialists = ['BiologistResearcher', 'BiologistModeler', 'BiologistExperimenter', 'BiologistReporter']
        self.tools = ['literature_search', 'simulation_engine', 'data_visualizer']

        # System prompt
        self.system_prompt = """You are the Biologist Manager, overseeing 4 specialist agents.
...
if __name__ == "__main__":
    ...
    result = manager.execute("Sample request for Biologist")
    print(result)
