#!/usr/bin/env python3
"""
PainterCreator - Specialist agent for Painter Office
"""
...
class PainterCreator:
    """
    Generates original artistic content for Painter
    ...
    def __init__(self):
        self.name = "PainterCreator"
        self.model = "deepseek-r1:14b"
        self.tools = ['generation_engine', 'style_analyzer', 'gallery_manager']
        self.system_prompt = """You are a PainterCreator specialist in the Painter office.
