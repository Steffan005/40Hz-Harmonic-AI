#!/usr/bin/env python3
"""
IChingSynthesizer - Specialist agent for I Ching Office
"""
...
class IChingSynthesizer:
    """
    Weaves insights into coherent narratives for I Ching
    ...
    def __init__(self):
        self.name = "IChingSynthesizer"
        self.model = "deepseek-r1:14b"
        self.tools = ['symbolism_db', 'pattern_detector', 'narrative_generator']
        self.system_prompt = """You are a IChingSynthesizer specialist in the I Ching office.
