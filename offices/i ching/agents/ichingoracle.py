#!/usr/bin/env python3
"""
IChingOracle - Specialist agent for I Ching Office
"""
...
class IChingOracle:
    """
    Provides divinations and predictions for I Ching
    ...
    def __init__(self):
        self.name = "IChingOracle"
        self.model = "deepseek-r1:14b"
        self.tools = ['symbolism_db', 'pattern_detector', 'narrative_generator']
        self.system_prompt = """You are a IChingOracle specialist in the I Ching office.
