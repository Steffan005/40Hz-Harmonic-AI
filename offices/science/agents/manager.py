#!/usr/bin/env python3
"""
ScienceManager - Coordination and oversight for Science Office
"""
...
class ScienceManager:
    """
    Manager agent for Science office.

    Coordinates 4 specialist agents:
        - ScienceResearcher: Conducts literature review and hypothesis generation for Science
    - ScienceModeler: Builds computational or mathematical models for Science
    - ScienceExperimenter: Designs and simulates experiments for Science
    - ScienceReporter: Writes research summaries and papers for Science
    """

    def __init__(self):
        self.domain = "Science"
        self.model = "deepseek-r1:14b"
        self.specialists = ['ScienceResearcher', 'ScienceModeler', 'ScienceExperimenter', 'ScienceReporter']
        self.tools = ['literature_search', 'simulation_engine', 'data_visualizer']

        # System prompt
        self.system_prompt = """You are the Science Manager, overseeing 4 specialist agents.
...
if __name__ == "__main__":
    ...
    result = manager.execute("Sample request for Science")
    print(result)
