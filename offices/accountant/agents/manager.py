#!/usr/bin/env python3
"""
AccountantManager - Coordination and oversight for Accountant Office
"""
...
class AccountantManager:
    """
    Manager agent for Accountant office.

    Coordinates 4 specialist agents:
        - AccountantAnalyst: Analyzes market data and financial statements for Accountant
    - AccountantRiskAssessor: Evaluates and quantifies risks for Accountant
    - AccountantAdvisor: Recommends investment strategies for Accountant
    - AccountantComplianceChecker: Ensures regulatory compliance for Accountant
    """

    def __init__(self):
        self.domain = "Accountant"
        self.model = "deepseek-r1:14b"
        self.specialists = ['AccountantAnalyst', 'AccountantRiskAssessor', 'AccountantAdvisor', 'AccountantComplianceChecker']
        self.tools = ['market_data_api', 'risk_model', 'compliance_engine']

        # System prompt
        self.system_prompt = """You are the Accountant Manager, overseeing 4 specialist agents.
...
if __name__ == "__main__":
    ...
    result = manager.execute("Sample request for Accountant")
    print(result)
