#!/usr/bin/env python3
"""
HistorianManager - Coordination and oversight for Historian Office
"""
...
class HistorianManager:
    """
    Manager agent for Historian office.

    Coordinates 4 specialist agents:
        - HistorianTeacher: Explains concepts and facilitates learning for Historian
    - HistorianTutor: Provides personalized instruction for Historian
    - HistorianCurriculumDesigner: Designs learning pathways for Historian
    - HistorianAssessor: Evaluates student understanding for Historian
    """

    def __init__(self):
        self.domain = "Historian"
        self.model = "deepseek-r1:14b"
        self.specialists = ['HistorianTeacher', 'HistorianTutor', 'HistorianCurriculumDesigner', 'HistorianAssessor']
        self.tools = ['concept_explainer', 'quiz_generator', 'progress_tracker']

        # System prompt
        self.system_prompt = """You are the Historian Manager, overseeing 4 specialist agents.
...
if __name__ == "__main__":
    ...
    result = manager.execute("Sample request for Historian")
    print(result)
