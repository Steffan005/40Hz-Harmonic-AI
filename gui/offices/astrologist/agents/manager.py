...
class AstrologistManager:
    ...
    Coordinates 4 specialist agents:
        - StarDataFetcher: Retrieves planetary positions and astronomical data
    - HoroscopeInterpreter: Interprets astrological aspects and generates horoscopes
    - NatalChartAnalyzer: Analyzes birth charts for personality insights
    - ReportWriter: Synthesizes astrological findings into readable reports
    """
